...
print
print W+"###########################"
print M+"Script Deface v1.0         "
print C+"Creator  : Mr. Raxo_R3nd   "
print R+"Team : Solo Player         "
print W+"###########################"
print
time.sleep(3)
mengetik(W+'Hallo Bro, kali ini gue buat tool Deface :)')
mengetik(C+'Cie yang gak tau buat sc deface...')
print
